...
class PembayaranController extends Controller
{
     ...
     * @param int $idPembayaran Id Pembayaran
     * @return string
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionView($idPembayaran)
    {
        return $this->render('view', [
            'model' => $this->findModel($idPembayaran),
        ]);
    }
    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            if ($model->load($this->request->post()) && $model->save()) {
                return $this->redirect(['view', 'idPembayaran' => $model->idPembayaran]);
            }
        } else {
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionUpdate($idPembayaran)
    {
        $model = $this->findModel($idPembayaran);
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionDelete($idPembayaran)
    {
        $this->findModel($idPembayaran)->delete();
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($idPembayaran)
    {
        if (($model = Pembayaran::findOne(['idPembayaran' => $idPembayaran])) !== null) {
            return $model;
        }
